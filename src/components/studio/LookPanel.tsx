    ...
    <div className="space-y-4">
      <label className="block">
        ...
        <textarea
          ...
          className="w-full resize-none rounded-md border border-line bg-raised px-2.5 py-2 text-[12px] leading-snug text-text outline-none placeholder:text-faint focus:border-accent"
        />
      ...
      <label className="block">
        ...
        <input
          ...
          className="w-full rounded-md border border-line bg-raised px-2.5 py-2 text-[12px] text-text outline-none placeholder:text-faint focus:border-accent"
        />
      </label>
      ...
      <details className="rounded-md border border-line bg-raised/50">
        ...
        <p className="border-t border-line px-2.5 py-2 font-mono text-[10px] leading-relaxed text-faint">
